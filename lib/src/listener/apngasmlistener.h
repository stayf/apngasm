...
public:
  ...
  virtual bool onPreAddFrame(const std::string &filePath, unsigned int delayNum,
                             unsigned int delayDen) const = 0;
  ...
  virtual void onPostAddFrame(const std::string &filePath,
